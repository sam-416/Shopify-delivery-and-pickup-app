...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,write_script_tags,write_customers,read_customers,write_draft_orders,read_draft_orders,read_orders,write_orders'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://tom-flower-delivery-app.herokuapp.com/webhook/order-update')
        ], 
        [
            'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'APP_UNINSTALLED'),
            'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://tom-flower-delivery-app.herokuapp.com/webhook/app-uninstalled'),
        ],
    ],
