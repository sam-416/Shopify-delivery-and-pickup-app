            ...
            <ul class="Polaris-VerticalStack Polaris-VerticalStack--listReset"
                ...
                <li>
                    <div class="Polaris-Bleed" style="--pc-bleed-margin-block-end-xs: var(--p-space-0);">
                        <label class="Polaris-Choice" for="NorSameEveryDaySlot">
                            <span class="Polaris-Choice__Control">
                                <span class="Polaris-RadioButton">
                                    <input id="NorSameEveryDaySlot" name="NorSlot" type="radio"
                                        class="Polaris-RadioButton__Input NorSameEveryDaySlot" value="true"
                                        @if ($options->delivery_slot_same_every_day_of_week == 'yes') checked @endif>
                ...
                <li>
                    <div class="Polaris-Bleed" style="--pc-bleed-margin-block-end-xs: var(--p-space-0);">
                        <label class="Polaris-Choice" for="NorDiffrentEachDaySlot">
                            <span class="Polaris-Choice__Control">
                                <span class="Polaris-RadioButton">
                                    <input id="NorDiffrentEachDaySlot" name="NorSlot" type="radio"
                                        class="Polaris-RadioButton__Input NorDiffrentEachDaySlot" value="false"
                                        @if ($options->delivery_slot_diffrent_each_days_of_the_week == 'yes') checked @endif>
                                    <span class="Polaris-RadioButton__Backdrop"></span>
                                </span>
                            </span>
                            <span class="Polaris-Choice__Label">
...
<div
    class="Polaris-Card__Section Polaris-Card__Section--subdued NorDeliverySlot__Container  @if ($options->delivery_slot_diffrent_each_days_of_the_week == 'yes') @else hide @endif">
            ...
            <ul role="tablist" class="Polaris-Tabs Polaris-Tabs--fitted">
                <li class="Polaris-Tabs__TabContainer" role="presentation">
                    <button id="sunday-delivery-slots" role="tab" type="button" tabindex="7"
                        class="Polaris-Tabs__Tab NorSpecificDaySlotTab Polaris-Tabs__Tab--selected"
                        aria-selected="true">
                ...
                <li class="Polaris-Tabs__TabContainer" role="presentation">
                    <button id="monday-delivery-slots" role="tab" type="button" tabindex="1"
                        class="Polaris-Tabs__Tab NorSpecificDaySlotTab" aria-selected="false">
    ...
    <div class="Polaris-FormLayout NorSlotContainer NorSlotContainer_1 hide">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div class="Polaris-Stack Polaris-Stack--vertical NorSlotData">
                    @foreach ($specificDaySlots['monday'] as $slot)
                ...
                <div class="Polaris-Stack">
                    <div class="Polaris-Stack__Item">
                        <div class="addSlotButton">
                            <button class="Polaris-Button NorAddSlot" type="button">
                                <span class="Polaris-Button__Content">
                                    <span class="Polaris-Button__Icon">
                                        <span class="Polaris-Icon">
    ...
    <div class="Polaris-FormLayout NorSlotContainer NorSlotContainer_2 hide">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div class="Polaris-Stack Polaris-Stack--vertical NorSlotData">
                    @foreach ($specificDaySlots['tuesday'] as $slot)
                        <div class="Polaris-Stack__Item">
                            <table class="table slotTable">
                                <thead>
                                    <tr>
    ...
    <div class="Polaris-FormLayout NorSlotContainer NorSlotContainer_3 hide">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div class="Polaris-Stack Polaris-Stack--vertical NorSlotData">
                    @foreach ($specificDaySlots['wednesday'] as $slot)
                        <div class="Polaris-Stack__Item">
                            <table class="table slotTable">
                                <thead>
                                    <tr>
    ...
    <div class="Polaris-FormLayout NorSlotContainer NorSlotContainer_4 hide">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div class="Polaris-Stack Polaris-Stack--vertical NorSlotData">
                    @foreach ($specificDaySlots['thursday'] as $slot)
                        <div class="Polaris-Stack__Item">
                            <table class="table slotTable">
                                <thead>
                                    <tr>
    ...
    <div class="Polaris-FormLayout NorSlotContainer NorSlotContainer_5 hide">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div class="Polaris-Stack Polaris-Stack--vertical NorSlotData">
                    @foreach ($specificDaySlots['friday'] as $slot)
                        <div class="Polaris-Stack__Item">
                            <table class="table slotTable">
                                <thead>
                                    <tr>
    ...
    <div class="Polaris-FormLayout NorSlotContainer NorSlotContainer_6 hide">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div class="Polaris-Stack Polaris-Stack--vertical NorSlotData">
                    @foreach ($specificDaySlots['saturday'] as $slot)
                        <div class="Polaris-Stack__Item">
                            <table class="table slotTable">
                                <thead>
                                    <tr>
    ...
    <div class="Polaris-FormLayout NorSlotContainer NorSlotContainer_7">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div class="Polaris-Stack Polaris-Stack--vertical NorSlotData">
                    @foreach ($specificDaySlots['sunday'] as $slot)
                        <div class="Polaris-Stack__Item">
                            <table class="table slotTable">
                                <thead>
                                    <tr>
...
<div
    class="Polaris-Card__Section Polaris-Card__Section--subdued NorDeliverySlot__Container_same @if ($options->delivery_slot_same_every_day_of_week == 'yes') @else hide @endif">
    <div class="Polaris-FormLayout NorSlotContainerSame NorSlotContainer_0">
        <div class="Polaris-FormLayout__Item">
            <div class="deliveryTimesContainer">
                <div id="myFieldIDError" class="Polaris-InlineError" style="display:none;">
                    <div class="Polaris-InlineError__Icon">
